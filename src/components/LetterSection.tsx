                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>เดินมาด้วย1ปี3เดือนแล้วนะ เค้ารักอ้วนมาก ขอบคุณที่อยู่ด้วยกันจนทุกวันนี้ ยังขอบคุณอ้วนตลอดที่ยังเลือกที่จะอยู่ข้างกัน อ้วนเข้ามาทำให้รู้ว่าถึงตัวเค้าจะไม่ได้ดีไปทุกอย่างแต่เค้ายังมีอ้วนที่คอยบอกคอยบ่นในเรื่องที่ผิดพลาด ขอบคุณมากๆที่ยังรักกันต่อไปนี้ขอให้เราดีขึ้นเพื่อกันเยอะๆนะ รักอ้วนมากๆนะ</p>
                                    </div>
