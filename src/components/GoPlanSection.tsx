...
const WISHES = [
  { id: 1,  text: "ไปเที่ยวเขาใหญ่ในฤดูฝน⛰️⛺️",                color: "#ffd6e7" },
  { id: 2,  text: "กินบุพเฟ่ร้านโปรด🥓", color: "#fce4ec" },
  { id: 3,  text: "หาค่าเฟ่ถ่ายรูป📸",        color: "#fff0f8" },
  { id: 4,  text: "นอนกอดแฟนนน🫂",           color: "#ffd6e7" },
  { id: 5,  text: "กินส้มตำ🍽️",          color: "#fce4ec" },
  { id: 6,  text: "เดินตลาด🍡",  color: "#fff0f8" },
  { id: 7,  text: "ดูหนังงงง🎥🎞️",          color: "#ffd6e7" },
  { id: 8,  text: "กินหมาล่าาาา🥘",         color: "#fce4ec" },
  { id: 9,  text: "ทำอาหารเช้า☀️",            color: "#fff0f8" },
  { id: 10, text: "ไปทะเล🌊",            color: "#ffd6e7" },
];
